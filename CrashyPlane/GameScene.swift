...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createPlayer() {
        ...
        addChild(player)
	// using rectange of solved issue of increasing score in single contact
		player.physicsBody = SKPhysicsBody(rectangleOf: playerTexture.size()) //(texture: playerTexture, size: playerTexture.size())
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        let value = player.physicsBody!.velocity.dy * 0.0015
